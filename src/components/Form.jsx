    ...
    <div className='static md:absolute  top-16 w-full '>
          <div className=' flex justify-between container mx-auto pt-16'>
            ...
            <form ref={form} onSubmit={sendEmail} className='pt-10 px-3 lg:p-10 w-full'>
              ...
              <div className="mb-6">
                <input type="text" name="user_name" className="bg-gray-50 input border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Name" required />
              </div>
              <div className="mb-6">
                <input type="email" name="user_email" className="bg-gray-50 input border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Email" required />
              </div>
              <div className="mb-6">
                <input type="text" name="user_subject" className="bg-gray-50 input border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Subject" required />
              </div>
              <div className="mb-6">
                <textarea rows="4" type="text" name="message" className="bg-gray-50 input border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Message" required />
              </div>
              <button onClick={()=>toast()} type="submit" value="Send" className="text-white bg-portfolio-fill focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full w-full sm:w-auto px-5 py-2.5 text-center block mx-auto text-xl">Send Message</button>
            </form>
            <form className='pt-10 pb-10 lg:pb-0 px-3 lg:p-10 lg:pr-10 w-full'>
              ...
              <div className=" w-[145px] h-[4px] bg-portfolio-fill">
