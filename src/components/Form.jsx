    ...
    <div className='static md:absolute  top-16 w-full '>
          <div className=' flex justify-between container mx-auto pt-16'>
            ...
            <form ref={form} onSubmit={sendEmail} className='pt-10 px-3 lg:p-10 w-full'>
              ...
              <div className="mb-6">
                <textarea rows="" type="text" name="message" className="bg-gray-50 input border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Message" required />
              </div>
